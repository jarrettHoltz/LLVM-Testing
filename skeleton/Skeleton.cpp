...
//                   builder.SetInsertPoint(&B, ++builder.GetInsertPoint());
//                   builder.SetInsertPoint(&B, ++builder.GetInsertPoint());
                     current_values.push_back(iter_value);
...
//                   builder.SetInsertPoint(&B, ++builder.GetInsertPoint());
              ...
              Value* name_array= names[0];
              Value* current_array = current_values[0];
              Value* size = ConstantInt::get(current_array->getType(), names.size());
              Value* args2[] = {start_name, current_array, size};
              builder3.CreateCall(assignedFunc, args2);
